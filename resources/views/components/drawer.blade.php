...
<aside class="z-50 h-full">
    <div class="flex flex-col justify-between h-full">
        <nav class="py-6 flex flex-col text-[#3b2f63]">
            ...
            <a href="{{ route('dashboard') }}" class="p-6 py-3 hover:text-[#261d44] hover:bg-[#b098ff79] transition">Profile</a>
            <a href="{{ route('dashboard') }}" class="p-6 py-3 hover:text-[#261d44] hover:bg-[#b098ff79] transition">Settings</a>
